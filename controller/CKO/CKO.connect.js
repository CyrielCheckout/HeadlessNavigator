...
//const cko = new Checkout(process.env.CKO_Demo_FR_PCFR_Secret, { pk: "pk_sbox_4ax4oynjgxigat4ffhp4jbmuwy2", scope: ['gateway', 'balances', 'disputes', 'flow', 'vault:instruments', 'vault', 'transfers', 'sessions:app', 'sessions:browser', 'risk','reports','issung'], environment: process.env.Checkout_ENV, })
